...
The packages that we use throughout this bundle are listed below. To install and load them, run:
...
This workshop was built using [Quarto](https://quarto.org/) and [bookdown](https://github.com/rstudio/bookdown).  You can fork and clone [this repository](https://github.com/mhweber/spatialdata.epaR2023.git), or simply clone directly and open corresponding .qmd files to follow along with material in RStudio.  You can also copy code snippets from the rendered book site and paste into your code files in RStudio.
