...
Vector data in R and `sf` can be broken down into three basic `geometric` primitives:

1. points
2. polylines
3. polygons

These primitives are the building blocks for all vector features in `sf`
