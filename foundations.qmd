...
### Answer
`::` disambiguates the function or method by selecting a definition from a particular namespace.
...
4. What is `glimpse`?  How is it useful compared to the `head` function?
:::
